...
const TourDetails = () => {
  ...
  const { 
    data:tour, 
    loading, 
    error } = useFetch(`${BASE_URL}/tours/${id}`);
              ...
              <div className="tour__content">
                ...
                <div className="tour__reviews">
                  ...
                  <Form onSubmit={submitHandler}>
                    <div className='d-flex align-items-center gap-3 mp-4 rating__group'>
                    ...
                    <div className="review__input">
                      <input type="text" ref={reviewsMsgRef} placeholder='Share you thoughts' required />
